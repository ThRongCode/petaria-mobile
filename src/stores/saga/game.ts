  ...
  try {
    ...
    if (profileResponse.success && profileResponse.data) {
      ...
      yield put(gameActions.setProfile({
        ...
        lastHuntTicketRegen: p.lastHuntTicketRegen,
        lastBattleTicketRegen: p.lastBattleTicketRegen,
        maxHuntTickets: p.maxHuntTickets,
        maxBattleTickets: p.maxBattleTickets,
        nextHuntTicketAt: p.nextHuntTicketAt,
        nextBattleTicketAt: p.nextBattleTicketAt,
        huntRegenMinutes: p.huntRegenMinutes,
        battleRegenMinutes: p.battleRegenMinutes,
        petCount: p.petCount,
