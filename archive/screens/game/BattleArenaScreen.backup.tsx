...
import { PokemonSprite, StatBar } from '@/components/GameUI'
...
export const BattleArenaScreen: React.FC = () => {
  ...
  const handleOpponentMove = () => {
    ...
    // Safety check: if no moves available, use a basic attack
    if (!availableMoves || availableMoves.length === 0) {
      console.error('Opponent has no moves available!')
      setIsAnimating(false)
      return
    }
      ...
      <ThemedView style={styles.container}>
        ...
        <View style={styles.opponentSection}>
          <View style={styles.pokemonInfo}>
            ...
            <StatBar 
              label=""
              current={opponentPet.currentHp}
              max={opponentPet.stats.hp}
              color={opponentPet.currentHp > opponentPet.stats.hp * 0.5 ? colors.success : colors.error}
              style={styles.hpBarContainer}
            />
          </View>
          <Image 
            source={typeof opponentPet.image === 'string' ? { uri: opponentPet.image } : opponentPet.image as any} 
        ...
        <View style={styles.playerSection}>
          <Image 
            source={typeof playerPet.image === 'string' ? { uri: playerPet.image } : playerPet.image} 
          ...
          <View style={styles.pokemonInfo}>
            ...
            <StatBar 
              ...
              max={playerPet.stats.maxHp}
              color={playerPet.currentHp > playerPet.stats.maxHp * 0.5 ? colors.success : colors.error}
              style={styles.hpBarContainer}
            />
          </View>
        </View>
